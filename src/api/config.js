...
import {IS_PRODUCTION, KEY_APP_ID, KEY_LOCATION_TEXT, KEY_VIP_LOCATION, KEY_DEFAULT_MALL, MALLID, APIURL, HOMEURL} from '../common/config'
...
export function MALL_ID() {
    let mallid = storage.get(KEY_DEFAULT_MALL, MALLID)
...
/// API前缀地址
export const API_URL_PREFIX = APIURL // IS_PRODUCTION ? G.apiUrl : G.apiUrl

// 领取会员卡至微信卡包地址
export const WX_API_URL = 'http://110.185.172.245:8287/Query.ashx'

// 主机地址
export const ROOT_PATH = IS_PRODUCTION ? 'http://sgweixin.dlairport.com:8878/DLAirport_Dist' : 'http://wxapp.tech-trans.com.cn'
/// 根路径地址
const LOCAL_HOST_IP = 'http://192.168.160.174:5000'
const HOME_URL_PREFIX = HOMEURL // G.homeUrl
